...
#. Download :download:`07 Motor Speed Controller.zip <https://github.com/sunfounder/unoq-ai-kit/releases/latest/download/07.Motor.Speed.Controller.zip>` and import it in App Lab. The app appears in **Apps** — click it to open.
