...
3. Import `10 Temperature & Humidity Monitor.zip` from `unoq-ai-kit\basic`.
5. Click **Run**.
6. Open the **Serial Monitor** to see temperature (°C) and humidity (%) readings every 2 seconds. Try breathing on the sensor — the humidity should spike.
