...
1. Download [`03 Voice Recorder.zip`](https://github.com/sunfounder/unoq-ai-kit/releases/latest/download/03.Voice.Recorder.zip).
2. In App Lab, go to **Apps** → **Create New App** → **Import App** → **Import from Computer** and open the package you downloaded.
3. Click **Run**.
4. Wait for `Ready.` in the **Output** window, then:
