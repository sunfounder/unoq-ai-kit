...
- **Ventilation** — D2/D3 motor acts as a fan. AUTO mode turns it on at 28°C; MANUAL mode uses the Web UI.
...
- **Smart Lighting** — RGB LED on D8/D7/D6. Choose any color from the Web UI color wheel or use voice color commands.
