...
A cloud LLM turns a typed request into a colour. The browser sends a
sentence from the Web UI, Python asks the model for a colour and reads the word it answers with, and the sketch drives the RGB LED.
"""
...
# Color name 鈫?code (matches sketch.ino switch cases)
COLOR_CODES = {
    "red":    1,
    "green":  2,
    "blue":   3,
...
print("馃挰 AI Light Control ready 鈥?configure your API Key and start chatting!")
