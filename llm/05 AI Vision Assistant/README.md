...
Use the camera on the Multimedia Carrier and a Vision Language Model to answer questions about the current image. The answer appears in the Web UI and is also read aloud.
...
- `sunfounder_tts` — Reads the answer out loud through the Multimedia Carrier's speaker

## Hardware

- Pan Tilt Kit ×1
- Arduino UNO Q
- camera on the Multimedia Carrier
...
- Camera on the Multimedia Carrier + Text Question
